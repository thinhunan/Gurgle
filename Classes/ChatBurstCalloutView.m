...
@implementation ChatBurstCalloutView

-(id) initWithFrame:(CGRect)frame text:(NSString *) text{
	UIImage *sharp = [UIImage imageNamed:@"chat_burst_mask.png"];
	UIImage *mask = [UIImage imageNamed:@"mask_for_burst.png"];
...
- (void) _adjustTextFrameWhenFliped{
	...
	CGRect textFrame = CGRectMake(49.0/190.0 * width, 
								  47.0/144.0 * height, 
								  95.0/190.0 *width, 
								  47.0/144.0 *height);
