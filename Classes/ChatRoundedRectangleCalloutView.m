//
//  ChatRoundedRectangleCalloutView.m
//  Gurgle
//
...
@implementation ChatRoundedRectangleCalloutView


-(id) initWithFrame:(CGRect)frame text:(NSString *) text{
	UIImage *sharp = [UIImage imageNamed:@"chat_rounded_rectangle_mask.png"];
	UIImage *mask = [UIImage imageNamed:@"mask_for_chat_rounded_ractangle.png"];
