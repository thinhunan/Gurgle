...
@implementation ChatBillboardCalloutView

-(id) initWithFrame:(CGRect)frame text:(NSString *) text{
	UIImage *sharp = [UIImage imageNamed:@"chat_billboard_mask.png"];
	UIImage *mask = [UIImage imageNamed:@"mask_for_billboard.png"];
...
- (void) _adjustTextFrameWhenFliped{
	...
	CGRect textFrame = CGRectMake(55.0/190.0 * width, 
								  21.0/144.0 * height, 
								  116.0/190.0 *width, 
								  93.0/144.0 *height);
