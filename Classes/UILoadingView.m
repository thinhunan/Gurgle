...
static UILoadingView *sShareLoadingView;
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self = [super initWithFrame:frame]) {
		...
		imageView = [[UIImageView alloc] initWithFrame:CGRectMake(boardView.bounds.size.width/2 - 24, 
																  15, 48, 48)];
...
{
	sShareLoadingView = [UILoadingView shareInstance];
...
{
	[self showInView:mainView image:image 
